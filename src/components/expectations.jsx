...
export default function Expectations(){
    return (
        <div className="py-12 flex flex-col items-center px-9">
            ...
            <br />
            <div className="flex overflow-hidden justify-center items-center flex-wrap font-nunito">
                <div className="overflow-hidden lg:w-72 bg-white lg:p-4 p-2 lg:mx-8 mx-4 my-4 shadow-lg text-gray-800 rounded w-full">
                ...
                <div className="overflow-hidden lg:w-72 bg-mainBlue text-white lg:p-4 p-2 lg:mx-8 mx-4 my-4 shadow-lg rounded w-full">
