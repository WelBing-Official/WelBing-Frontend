...
export default function Signup(){
    return (
        <AuthLayout page="signup">
            ...
            <select className="input font-nunito focus:outline-none rounded-sm">
            ...
            <input 
            type="text"
            className="input mb-3 focus:outline-none shadow-md rounded-sm text-sm text-gray-800 font-nunito" 
            /> <br />
            <label className="font-lato text-sm text-gray-500 mr-2">
                Email
            </label> <br />
